...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor c = contentResolver.query(WeatherContract.LocationEntry.CONTENT_URI,
        ...
        if (c.moveToFirst()) {
            ...
            Uri insertedLocation = contentResolver.insert(WeatherContract.LocationEntry.CONTENT_URI, contentValues);
            id = ContentUris.parseId(insertedLocation);
        }
        return id;
    }
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                for (int i = 0; i < cVVector.size(); i++) {
                    contentValues[i] = cVVector.get(i);
                }
                ContentResolver contentResolver = mContext.getContentResolver();
                contentResolver.bulkInsert(WeatherEntry.CONTENT_URI, contentValues);
            }
